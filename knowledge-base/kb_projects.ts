export const projectsKnowledgeBase = `
No.01 ---------
...
**Project: China R&D DDT**      Project Type: New Development                    Project Size: Middle

**Role: Product Owner**               Team Size: 8

**Responsibility:**

◦ Led the product vision and roadmap for China R&D Data-Driven Transparency (DDT), focusing on enhancing data accessibility and decision-making.

◦ Designed and delivered executive dashboards in PowerBI to visualize key business metrics, project statuses, and resource allocation.

◦ Managed the development of an AWS-hosted system to centralize and analyze business data, improving reporting efficiency.

◦ Developed a strategic vendor engagement roadmap to align external partners with internal data initiatives.

**Achievement:**

◦ Successfully launched the DDT platform, providing leadership with real-time insights and leading to a nomination for the 2021 Volvo APAC President Award.

◦ Improved data-driven decision-making speed by 40% through centralized dashboards and automated reporting.

◦ Strengthened vendor collaboration by creating a transparent and aligned roadmap for data integration.

**Skill Tag:** Agile | Data & BI | Software Engineering

No.10 ---------

**Time: 2023-05 ~ Present**      Company: Volvo Cars Asia Pacific                Title: Product Cluster Owner

**Project: APAC Quality & Certification Systems**  Project Type: New Development & Continuous Improvement Project Size: Large

**Role: Product Cluster Owner**             Team Size: 10+

**Responsibility:**

◦ Lead a cluster of products focused on Quality & Certification for the APAC region, ensuring compliance with evolving regulatory frameworks in China.

◦ Oversee the complete rebuild of the Environment Information Publish System to meet new standards from the Ministry of Ecology.

◦ Drive the strategy and deployment of Robotic Process Automation (RPA) tools to automate manual reporting and approval workflows, reducing operational overhead.

◦ Manage multi-national, cross-functional product teams to deliver solutions for complex regulatory challenges, such as the GB-44496 SUMS audits.

**Achievement:**

◦ Successfully initiated the rebuild of a critical compliance system, aligning it with new national regulations ahead of schedule.

◦ Automated over 20 manual reporting tasks using RPA, saving an estimated 500+ hours of manual work annually.

◦ Enhanced the organization's readiness for mandatory government audits through proactive system and process improvements.

**Skill Tag:** Agile | Regulatory & Compliance | Automation
`;
