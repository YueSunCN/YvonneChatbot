...
const Chatbot: React.FC<ChatbotProps> = ({ knowledgeBase }) => {
  ...
  return (
    <div className="flex flex-col h-full">
        <div className="py-1 px-2 border-b border-gray-200 dark:border-gray-700 text-center">
            <h1 className="text-base font-semibold text-gray-900 dark:text-gray-100">Yvonne's Chatbot</h1>
